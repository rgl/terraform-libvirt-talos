locals {
  ...
  # see the CiliumL2AnnouncementPolicy type at https://github.com/cilium/cilium/blob/v1.14.3/pkg/k8s/apis/cilium.io/v2alpha1/l2announcement_types.go#L20-L39
  # see the CiliumLoadBalancerIPPool type at https://github.com/cilium/cilium/blob/v1.14.3/pkg/k8s/apis/cilium.io/v2alpha1/lbipam_types.go#L23-L47
...
// see https://www.talos.dev/v1.5/kubernetes-guides/network/deploying-cilium/#method-4-helm-manifests-inline-install
...
// see https://github.com/cilium/cilium/tree/v1.14.3/install/kubernetes/cilium
