locals {
  ...
  # see the CiliumL2AnnouncementPolicy type at https://github.com/cilium/cilium/blob/v1.19.4/pkg/k8s/apis/cilium.io/v2alpha1/l2announcement_types.go#L23-L43
  # see the CiliumLoadBalancerIPPool type at https://github.com/cilium/cilium/blob/v1.19.4/pkg/k8s/apis/cilium.io/v2alpha1/lbipam_types.go#L23-L48
