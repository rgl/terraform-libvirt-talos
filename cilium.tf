locals {
  ...
  # see the CiliumL2AnnouncementPolicy type at https://github.com/cilium/cilium/blob/v1.15.2/pkg/k8s/apis/cilium.io/v2alpha1/l2announcement_types.go#L23-L42
  # see the CiliumLoadBalancerIPPool type at https://github.com/cilium/cilium/blob/v1.15.2/pkg/k8s/apis/cilium.io/v2alpha1/lbipam_types.go#L23-L47
...
// see https://github.com/cilium/cilium/tree/v1.15.2/install/kubernetes/cilium
