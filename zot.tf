...
#       https://github.com/project-zot/helm-charts/tree/zot-0.1.97/charts/zot/values.yaml
#    NB make sure you are seeing the same version of the chart that you are installing.
# see https://zotregistry.dev/v2.1.14/install-guides/install-guide-k8s/
...
data "helm_template" "zot" {
  ...
  version      = "0.1.97" # app version 2.1.14.
