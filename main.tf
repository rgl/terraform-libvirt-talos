...
locals {
  kubernetes_version = "1.26.4" # see https://github.com/siderolabs/kubelet/pkgs/container/kubelet
  talos_version      = "1.4.2"  # see https://github.com/siderolabs/talos/releases
