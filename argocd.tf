locals {
  ...
  argocd_manifests = [
    ...
    # see https://github.com/argoproj/argo-helm/blob/argo-cd-7.6.8/charts/argo-cd/templates/argocd-server/certificate.yaml
...
#       https://github.com/argoproj/argo-helm/blob/argo-cd-7.6.8/charts/argo-cd/values.yaml
...
data "helm_template" "argocd" {
  ...
  version      = "7.6.8" # app version 2.12.4.
