locals {
  ...
  argocd_manifests = [
    ...
    # see https://github.com/argoproj/argo-helm/blob/argo-cd-8.1.3/charts/argo-cd/templates/argocd-server/certificate.yaml
...
#       https://github.com/argoproj/argo-helm/blob/argo-cd-8.1.3/charts/argo-cd/values.yaml
...
data "helm_template" "argocd" {
  ...
  version      = "8.1.3" # app version 3.0.11.
