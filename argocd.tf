locals {
  ...
  argocd_manifests = [
    ...
    # see https://github.com/argoproj/argo-helm/blob/argo-cd-7.7.1/charts/argo-cd/templates/argocd-server/certificate.yaml
...
#       https://github.com/argoproj/argo-helm/blob/argo-cd-7.7.1/charts/argo-cd/values.yaml
...
data "helm_template" "argocd" {
  ...
  version      = "7.7.1" # app version 2.13.0.
