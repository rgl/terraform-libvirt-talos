locals {
  ...
  argocd_manifests = [
    ...
    # see https://github.com/argoproj/argo-helm/blob/argo-cd-9.1.6/charts/argo-cd/templates/argocd-server/certificate.yaml
...
#       https://github.com/argoproj/argo-helm/blob/argo-cd-9.1.6/charts/argo-cd/values.yaml
...
data "helm_template" "argocd" {
  ...
  version      = "9.1.6" # app version 3.2.1.
