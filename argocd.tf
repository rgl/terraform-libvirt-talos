locals {
  ...
  argocd_manifests = [
    ...
    # see https://github.com/argoproj/argo-helm/blob/argo-cd-8.0.12/charts/argo-cd/templates/argocd-server/certificate.yaml
...
#       https://github.com/argoproj/argo-helm/blob/argo-cd-8.0.12/charts/argo-cd/values.yaml
...
data "helm_template" "argocd" {
  ...
  version      = "8.0.12" # app version 3.0.4.
